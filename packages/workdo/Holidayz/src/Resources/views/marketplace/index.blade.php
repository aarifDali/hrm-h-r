            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Hotel&Room Management provide Facilities people all over the world and make booking hotel rooms online easy and fast. Easily manage your hotel&room management, Room Types, Room Features, Facilities, and Room Booking from one intuitive dashboard.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('One Solution For All Your Hotel&Room Management Needs')}}</h2>
                <p>{{__('Simplify and automate your hotel operations with a highly flexible and feature-rich system.')}}</p>
            </div>
            <div class="row row-gap padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('The Smartest Way To Manage Your Hotel&Room Management')}}</h2>
                        </div>
                        <p>{{__('Holidayz monitors your hotel&room management performance like a coach and lets you know whether you are on track. Get real time reports about every hotel&room management activity you make, make smarter decisions, and manage your business’s general hotel&room management more efficiently.')}} </p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Manage All Your Hotel&Room Management From One Place')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Manage every aspect of your business hotel&room management from one place. Monitor your hotel&room management, Room Booking invoice and customer from a single comprehensive dashboard.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Access Your Customers’ Information')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Easily view and control the details of all your customers. Create user accounts and edit existing user information, manage your contacts, and do a lot more from anywhere - with a single tool.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Manage All Your Hotel&Room Management Management Tasks Quickly And Easily From One Place')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Control and keep track of your invoices with ease. Easily track current trends, room details, and more. manage hotel theme, manage hotel amenities, and carry out complex tasks in a few simple clicks.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap  padding-bottom">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Manage Your Hotel&Room Management From One Place')}}</h2>
                        </div>
                        <p>{{__('')}}</p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Oprate a Fast and Easy Holidaz process')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Make your Booking process fast and convenient for your customers. select date of when you want to stay in hotel room and select the room your customers want to stay and after click on Book Now.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                ...
                                <div class="acnav-list">
                                    <p>{{__('Get paid for work done, fast. Integrate several payment options for diverse customers and make the payment process stress-free. Easily safeguard your customers’ payment by using Stripe, PayPal, Flutterwave, and more.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                ...
                                <div class="acnav-list">
                                    <p>{{__('Integrate the Twilio app and never miss an important notification again. Get notified when tasks or room booking are completed and get notifications about meetings and new room booking sent to your mobile phone via text.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap align-items-center padding-bottom">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Modify Vital Hotel&Room Management Info With Ease')}}</h2>
                        </div>
                        <p>{{__('Modify and update your generated hotel&room management room types with ease. Add new room booking and room details without stress. Holidayz allows you to create and maintain the data of each customer. You get access to all essential information through a well-maintained format.')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
            ...
            <div class="row row-gap align-items-center ">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        ...
                        <p> {{__('Holidays also provide filter facility to customers. Customer easily get him/her choice rooms by using filter option and search your room option.')}}</p>
                    </div>
                </div>
            </div>
        </div>
