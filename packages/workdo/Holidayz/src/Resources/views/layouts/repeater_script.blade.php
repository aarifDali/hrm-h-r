<script type="text/javascript" src="{{ asset('packages/workdo/Holidayz/src/Resources/assets/bootstrap-material-design/bootstrap-material-design.umd.min.js') }}"></script>
