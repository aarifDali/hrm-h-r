                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="login-left">
                            <a href="{{ route('customer.login.page', [$slug,$lang]) }}" class="back-btn">
                                <span class="svg-ic">
                            ...
                            {!! Form::open(
                                [
                                    'route' => ['hotel.customer.password.email', $slug, !empty($is_cart) && $is_cart == true ? $is_cart : false],
                                    'class' => 'login-form',
                                ],
                                ['method' => 'POST'],
                            ) !!}
                            <div class="create-account">
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::text('email', null, ['class' => 'form-control', 'placeholder' => __('Enter Your Email'), 'autofocus']) }}
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ __('We can not find a hotel customer with that email address') }}.</strong>
                                            </span>
                                        @enderror
                                </div>

                                    <div for="exampleInputPassword1">
